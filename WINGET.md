...
them. PDF and CSV output defaults to the `output` and `csv` directories beside
that file. A new terminal may be required before the command alias is available.
